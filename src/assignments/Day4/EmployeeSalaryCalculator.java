...
class Employee {
    ...
    public void addWork() {
        if (hoursPerDay > 6 && perDaySalary<500) {
        	
        	finalSalary+=15+(perDaySalary*hoursPerDay);
        }
        else if(hoursPerDay > 6 && perDaySalary>500)
        {
        	finalSalary+=5+(perDaySalary*hoursPerDay);
        }
        else if(hoursPerDay < 6 && perDaySalary<500)
        {
        	finalSalary+=10+(perDaySalary*hoursPerDay);
        }
        else
        {
        	finalSalary+=perDaySalary*hoursPerDay;
        }
    }
