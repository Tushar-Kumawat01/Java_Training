...
public interface ITollBooth {
    ...
    void calculateToll(ITruck iTruck);
    
    //Displays the current totals for receipts and the number of trucks since the last collection.
     
    void displayData();

    // Simulates the collection of receipts. It displays the final totals and then resets the receipt and truck counts to zero.
